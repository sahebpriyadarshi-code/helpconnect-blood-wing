  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await saveProfileMutation.mutateAsync({
        name: name.trim(),
        role: role as any, // Cast to any to bypass strict type check for now if needed, or fix hook type
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={role} onValueChange={setRole} required>
              ...
              <SelectContent>
                <SelectItem value={UserRole.recipient}>Blood Requester</SelectItem>
                <SelectItem value={UserRole.donor}>Blood Donor</SelectItem>
              </SelectContent>
            </Select>
          </div>
          <div className="space-y-2">
